...
namespace QLNV_ATBM
{
    public partial class QLNV_LIST_VIEWS : Form
    {
        private OracleConnection conn;
        public QLNV_LIST_VIEWS(OracleConnection conn)
        {
            InitializeComponent();
            this.conn = conn;
        }
        ...
        private void QLNV_LIST_VIEWS_Load(object sender, EventArgs e)
        {
            OracleCommand command = new OracleCommand();
            command.CommandType = CommandType.StoredProcedure;
            command.CommandText = "NGAN.SEE_VIEW";
