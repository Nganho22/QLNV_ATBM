...
namespace QLNV_ATBM
{
    public partial class QLNV_ADD_ROLE : Form
    {
        private OracleConnection conn;
        public QLNV_ADD_ROLE(OracleConnection conn)
        {
            InitializeComponent();
            this.conn = conn;
        }

        private void QLNV_ADD_ROLE_Load(object sender, EventArgs e)
        {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "NGAN.GRANT_ROLE_TO_USER";
            ...
            {
                command.Parameters.Add("p_input3", OracleDbType.Varchar2).Value = " WITH ADMIN OPTION";
            }
            else
            {
                command.Parameters.Add("p_input3", OracleDbType.Varchar2).Value = " ";
            }
