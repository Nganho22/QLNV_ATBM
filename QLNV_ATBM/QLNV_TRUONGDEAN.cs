...
namespace QLNV_ATBM
{
    public partial class QLNV_TRUONGDEAN : Form
    {
        OracleConnection conn;
        public QLNV_TRUONGDEAN(OracleConnection conn)
        {
            InitializeComponent();
            this.conn = conn;
        }

        private void QLNV_TRUONGDEAN_Load(object sender, EventArgs e)
        {
            conn.Open();
            OracleCommand command = new OracleCommand();
            command.CommandType = CommandType.StoredProcedure;
            command.CommandText = "NGAN.DA_PROC_SELECT_DEAN";
